...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_login_32px.png"))); // NOI18N
        ...
        lbUserName.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_email_48px.png"))); // NOI18N
        ...
        lbPassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_password_48px.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (!Validation.validatePassword(password)) {
            JOptionPane.showMessageDialog(this, "Mật khẩu phải từ 6-16 ký tự", "Lỗi", JOptionPane.ERROR_MESSAGE);
            txPassword.requestFocus();
            return;
        }

        RunClient.clientController.login(email, password);
        setLoading(true);
    }//GEN-LAST:event_btnLoginActionPerformed

    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        this.dispose();
        RunClient.openScene(RunClient.Scene.SIGNUP);
