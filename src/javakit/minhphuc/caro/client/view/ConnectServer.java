...
public class ConnectServer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txIP.setText(SystemConstant.LOCALHOST);

        txPort.setFont(new java.awt.Font("Consolas", 0, 18)); // NOI18N
        txPort.setText(SystemConstant.PORT.toString());
    ...
    private void connect(String ip, int port) {
        ...
        new Thread(() -> {
            // call controller
            String result = RunClient.clientController.startConnection(ip, port);

            // check result
            if (result.equals(SystemConstant.SUCCESS)) {
                onSuccess();
            } else {
