...
import javakit.minhphuc.util.Validation;
...
public class Profile extends javax.swing.JFrame {
    ...
    PlayerDTO playerCurr = new PlayerDTO();
    ...
    private void setAvatar(String[] avatars) {
    ...
    public void loadProfileData(String email) {
        setLoading(true);
        RunClient.clientController.getProfile(email);
    }

    public void setProfileData(PlayerDTO player) {
        playerCurr = player;

        // check is the acc owner
        boolean isMe = player.getEmail().equals(RunClient.clientController.getPlayer().getEmail());

        // put data to form
        lbWinCount.setText("" + player.getWin());
        lbTieCount.setText("" + player.getDraw());
        lbLoseCount.setText("" + player.getLose());

        plContainer.setBorder(javax.swing.BorderFactory.createTitledBorder(null, player.getName() + " #" + player.getId(), javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Consolas", 1, 16))); // NOI18N
        txEmail.setText(player.getEmail());
        txName.setText(player.getName());
        txYearOfBirth.setText("" + player.getYearOfBirth());
        cbGender.setSelectedItem(player.getGender());
        cbAvatar.setSelectedItem(hAvatar.get(player.getAvatar()));

        lbScore.setText(String.valueOf(player.getScore()));
        lbMatchCount.setText("" + player.getMatch());
        lbCurrentStreak.setText(getCurrentStreakStr(player.getStreak()));
        lbWinRate.setText(player.getWinRate() + "%");
    ...
    public void setProfileSaveLoading(boolean isLoading) {
        btnProfileSave.setText(isLoading ? SystemConstant.Loading : SystemConstant.SAVE);
    ...
    private void initComponents() {
        ...
        lbEmail.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_email_48px.png"))); // NOI18N

        txEmail.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        txEmail.setToolTipText("Email");

        lbUserName.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_name_48px_1.png"))); // NOI18N
        ...
        lbGender.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_gender_48px.png"))); // NOI18N
        ...
        lbBirthday.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_birthday_cake_48px_2.png"))); // NOI18N
        ...
        btnProfileSave.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_ok_24px.png"))); // NOI18N
        btnProfileSave.setText(SystemConstant.SAVE);
        ...
        btnProfileCancel.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_replay_24px.png"))); // NOI18N
        btnProfileCancel.setText(SystemConstant.BACK);
        ...
        lbPassword.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_password_48px.png"))); // NOI18N
    ...
    private void btnProfileChangePassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileChangePassActionPerformed
        RunClient.openScene(RunClient.Scene.CHANGE_PASSWORD);
    ...
    private void btnProfileSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileSaveActionPerformed
        ...
        String avatar = Avatar.getOne(cbAvatar.getSelectedItem().toString());
        ...
        // call clientController function
        RunClient.clientController.updateProfile(playerCurr.getId(), email, name, avatar, yearOfBirth, gender);
...
//        RunClient.closeScene(RunClient.Scene.PROFILE);
        this.dispose();
