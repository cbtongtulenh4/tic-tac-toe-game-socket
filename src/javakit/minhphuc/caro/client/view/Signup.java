...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbHeaderText.setText("REGISTRATION");
        ...
        lbPassword1.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_password_reset_48px.png"))); // NOI18N
        ...
        btnSignup.setIcon(new ImageIcon(getClass().getResource("/javakit/minhphuc/caro/client/view/asset/icons8_slide_up_32px.png"))); // NOI18N
    ...
    private void btnSignupMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSignupMouseClicked
        try {
            ...
            int yearOfBirth;
            try{
                yearOfBirth = Integer.parseInt(txYearOfBirth.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Error NumberFormat", "Lỗi", JOptionPane.ERROR_MESSAGE);
            ...
            if (!Validation.validateYear(yearOfBirth)) {
            ...
            setLoading(true);
            RunClient.clientController.signup(email, password, name, gender, yearOfBirth, avatar);
